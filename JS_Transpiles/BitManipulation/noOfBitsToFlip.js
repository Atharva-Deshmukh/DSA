...
*/
function countSetBits_BK_Algo(n) {
    let count = 0;
    while (n > 0) {
        n = n & (n - 1);
        count++;
...
function bitsToBeFlipped(A, B) {
    return countSetBits_BK_Algo(A ^ B);
}
console.warn('Bits to convert 10 to 20 -> ', bitsToBeFlipped(10, 20));
console.warn('Bits to convert 7 to 9 -> ', bitsToBeFlipped(7, 9));
console.warn('Bits to convert 8 to 7 -> ', bitsToBeFlipped(8, 7));
