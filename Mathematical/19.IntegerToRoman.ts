...
NOTE: Roman numerals are capped to 3999. Because multiple repeatition of symbols are not allowed.
...
function intToRoman(num: number): string {
    ...
    /* Create a new map to store subtraction combinations and map should be in descending order */
    ...
    // Iterate the map in descending order and keep concatenating the values until num >= value.
